...
//如果启用自动旋转，则必须在动画循环中调用controls.update（）
	...
	// 更改鼠标中间键为旋转 modified by lixin 20200824
	//this.mouseButtons = { ORBIT: THREE.MOUSE.MIDDLE, ZOOM: THREE.MOUSE.MIDDLE, PAN: THREE.MOUSE.RIGHT };
...
// 重置
	...
	//zoom事件 added by lixin 20200831
	...
	function onMouseDown( event ) {
		...
		switch ( event.button ) {
			...
			//修改中间键+shift为旋转 modified by lixin 20200824
	...
	function onMouseUp( event ) {
		...
		scope.dispatchEvent( endEvent, event );
